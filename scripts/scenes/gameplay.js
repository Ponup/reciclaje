...
define( [ 'game/context', 'scenes/base', 'actors/element', 'actors/container', 'actors/statspanel', 'game/engine', 'text!templates/gameplay.html', 'game/scores', 'actors/clock', 'utils/arrays' ], function( gaco, Scene, Element, Container, StatsPanel, GameEngine, gameplayHtml, Scores, ClockActor, ArrayUtils )
{
